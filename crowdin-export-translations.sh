...
curl \
  https://api.crowdin.com/api/project/hadescoincom/export?key=$CROWDIN_PROJECT_KEY
...
wget -O temp/$archiveName https://api.crowdin.com/api/project/hadescoincom/download/all.zip?key=$CROWDIN_PROJECT_KEY && unzip ./temp/$archiveName -d ./temp && rm -rf ./temp/$archiveName
