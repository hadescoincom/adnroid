...
-keep class * extends com.hds.hdswallet.base_screen.BaseActivity
-keep class * extends com.hds.hdswallet.base_screen.BaseFragment
-keep class com.hds.hdswallet.core.Api
-keep class com.hds.hdswallet.core.AppConfig
-keep,includedescriptorclasses class com.hds.hdswallet.core.views.PasswordStrengthView { *; }
-keep,includedescriptorclasses class com.hds.hdswallet.core.entities.** { *; }
-keep,includedescriptorclasses class com.hds.hdswallet.core.listeners.** { *; }
-keep,includedescriptorclasses class com.hds.hdswallet.core.helpers.** { *; }
-keep,includedescriptorclasses class com.hds.hdswallet.screens.settings.SettingsFragmentMode { *; }
-keep,includedescriptorclasses class com.hds.hdswallet.screens.settings.** { *; }
