...
class BackgroundService : JobService() {
    ...
    companion object {
        ...
        private const val CHANNEL_ID = "com.hds.hdswallet.service.BackgroundService"
                    ...
                    if(txDescription?.status == TxStatus.Pending || txDescription?.status == TxStatus.Registered
                        ...
                        if (txDescription != null && txDescription.sender == TxSender.RECEIVED) {
                            ...
                            if(App.isAppRunning && App.isForeground && App.isAuthenticated) {
                                ...
                                val notification = com.hds.hdswallet.core.entities.Notification(NotificationType.Transaction,
