...
import com.hds.hdswallet.service.BackgroundService
        ...
        biometricPrompt = BiometricPrompt(fromFragment, executor,
                object : BiometricPrompt.AuthenticationCallback() {
                    override fun onAuthenticationError(errorCode: Int,
                        ...
                        {
                            resultCallback.invoke(com.hds.hdswallet.core.views.Status.CANCEL)
                        }
                        else{
                            resultCallback.invoke(com.hds.hdswallet.core.views.Status.ERROR)
                        }
                    }
                    ...
                    override fun onAuthenticationSucceeded(
                        ...
                        resultCallback.invoke(com.hds.hdswallet.core.views.Status.SUCCESS)
                    }

                    override fun onAuthenticationFailed() {
                        super.onAuthenticationFailed()
                        resultCallback.invoke(com.hds.hdswallet.core.views.Status.FAILED)
                    }
                })
