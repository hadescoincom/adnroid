...
class RestoreManager {
    ...
    fun startDownload(file: File) {
        val link =  when (BuildConfig.FLAVOR) {
            AppConfig.FLAVOR_MAINNET -> "https://mobile-restore.hadescoin.com/mainnet/mainnet_recovery.bin"
            AppConfig.FLAVOR_TESTNET -> "https://mobile-restore.hadescoin.com/testnet/testnet_recovery.bin"
            else -> "https://mobile-restore.hadescoin.com/masternet/masternet_recovery.bin"
        }
