...
object AppConfig {
    ...
    const val FLAVOR_TESTNET = "hdstestnet"
    ...
    const val SUPPORT_EMAIL = "support@hadescoin.com"
    ...
    const val HDS_SITE_LINK = "https://www.hadescoin.com/"
    const val HDS_EXCHANGES_LINK = "$HDS_SITE_LINK#exchanges"
    ...
    val EXPLORER_LINK
        get() = "https://${EXPLORER_PREFIX}explorer.hadescoin.com/"
