 ...
 *  12/4/18.
 */
class HdsEditText : AppCompatEditText {
    companion object {
    ...
    private fun init(context: Context, attrs: AttributeSet?) {
        ...
        if (attrs != null) {
            val a = context.theme.obtainStyledAttributes(
                    attrs,
                    R.styleable.HdsEditText,
                    0, 0
            )

            isStateAccent = a.getBoolean(R.styleable.HdsEditText_state_accent, false)
            isStateNormal = a.getBoolean(R.styleable.HdsEditText_state_normal, false)
            isStateError = a.getBoolean(R.styleable.HdsEditText_state_error, false)
        }
    }
}
