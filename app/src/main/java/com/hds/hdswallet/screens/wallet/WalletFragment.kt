...
import com.hds.hdswallet.core.helpers.convertToHdsWithSign
...
import com.hds.hdswallet.screens.confirm.DoubleAuthorizationFragmentMode
...
import com.hds.hdswallet.core.views.gone
import com.hds.hdswallet.screens.timer_overlay_dialog.TimerOverlayDialog
    ...
    override fun configInProgress(receivingAmount: Long, sendingAmount: Long, expandCard: Boolean, isEnablePrivacyMode: Boolean) {
        ...
        when (receivingAmount) {
            0L -> {
                ...
                receiving.text = receivingAmount.convertToHdsWithSign(false)
        ...
        when (sendingAmount) {
            0L -> sendingGroup.visibility = View.GONE
                ...
                sending.text = sendingAmount.convertToHdsWithSign(true)
