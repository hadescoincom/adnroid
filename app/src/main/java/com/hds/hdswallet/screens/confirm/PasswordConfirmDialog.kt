...
class PasswordConfirmDialog: BaseDialogFragment<PasswordConfirmPresenter>(), PasswordConfirmContract.View {
    ...
    enum class Mode {
        RemoveWallet, ChangeNode, ChangeSettings, SendHds
    }
    ...
    override fun init(isFingerprintEnable: Boolean) {
        ...
        if(presenter?.repository?.isFaceIDEnabled() == true)
        {
            ...
            when (mode) {
                ...
                Mode.SendHds -> description.setText(R.string.use_faceid_ot_enter_your_password_to_confirm_transaction)
            }
        }
        else
        {
            when (mode) {
                ...
                Mode.SendHds -> description.setText(if (withBiometric) R.string.use_fingerprint_ot_enter_your_password_to_confirm_transaction else R.string.enter_your_password_to_confirm_transaction)
            }
        }


        if (mode == Mode.SendHds)
            ...
            when (it) {
                ...
                Status.CANCEL -> {
                    when (mode) {
                        ...
                        Mode.SendHds -> description.setText(R.string.enter_your_password_to_confirm_transaction)
                    }
