...
class ShareTransactionDetailsView : FrameLayout {
    ...
    fun configGeneralTransactionInfo(txDescription: TxDescription?) {
        ...
        when (txDescription.sender) {
            TxSender.RECEIVED -> txCurrency.setImageResource(R.drawable.currency_hds_receive)
            TxSender.SENT -> txCurrency.setImageResource(R.drawable.currency_hds_send)
        }
        ...
        amount.text = txDescription.amount.convertToHdsString()
