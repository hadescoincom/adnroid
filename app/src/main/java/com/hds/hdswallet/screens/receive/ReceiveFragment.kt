...
import com.hds.hdswallet.core.views.TagAdapter
...
import com.hds.hdswallet.core.views.PasteEditTextWatcher
...
class ReceiveFragment : BaseFragment<ReceivePresenter>(), ReceiveContract.View {
    ...
    private val amountWatcher: com.hds.hdswallet.core.watchers.TextWatcher = object : com.hds.hdswallet.core.watchers.TextWatcher {
    ...
    override fun setAmount(newAmount: Double) {
        amount.setText(newAmount.convertToHdsString())
